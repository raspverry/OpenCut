...
describe('EditorPage', () => {
  ...
  it('renders the OpenCut AI Shorts editor shell', () => {
    ...
    expect(screen.getByText('Media Bin')).toBeTruthy()
  ...
  it('keeps editing tools inside an editor workspace layout', () => {
    ...
    expect(document.querySelector('[data-editor-zone="statusbar"]')).toBeTruthy()
    expect(screen.getByLabelText('Program monitor')).toBeTruthy()
    expect(screen.getByLabelText('Editor transport')).toBeTruthy()
